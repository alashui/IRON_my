...
///////////////////////////////
// simple random number gen.随机数发生器
///////////////////////////////
class XorShift
{
private:
...
public:
    ...
    {
        mSeed = (seed == 0) ? 0xdeadbeefu : seed;//0xdeadbeefu表示一个十六进制数，大概是用来做标记的
    }
    uint64_t rand()
    {
        mSeed ^= mSeed << 13;
...
///////////////////////////////
// normal distribution gen　　//通过均匀分布产生正太分布的方法（中心极限定理）
///////////////////////////////
template <typename NumericalType>
...
private:
    NumericalType uniform()//产生０－１的随机数
    {
